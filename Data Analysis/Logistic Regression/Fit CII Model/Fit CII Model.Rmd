...
jpeg("C:\\Users\\willi\\sfuvault2\\CornellStudy\\Tex\\Plots\\CII_Analysis\\CII_Disper_Ref_Scaled.jpeg")
plot(pure_rep_plot_ref_scaled)
dev.off()
```
...
jpeg("C:\\Users\\willi\\sfuvault2\\CornellStudy\\Tex\\Plots\\CII_Analysis\\CII_Boxplots.jpeg")
grid.arrange(grobs = all_boxplots, ncol=3)
dev.off()
```
